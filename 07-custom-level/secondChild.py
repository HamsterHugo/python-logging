...
def second_logs():
    ...
    logger.success('This is a simple SUCCESS log from "second.py".')
    logger.complete('This is a simple COMPLETE log from "second.py".')
    logger.fail('This is a simple FAIL log from "second.py".')
